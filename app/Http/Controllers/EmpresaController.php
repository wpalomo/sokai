...
class EmpresaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        //factura
        $carpeta = "../server/" . $id . "/comprobantes";
        if (!file_exists($carpeta)) {
            mkdir($carpeta, 0777, true);
        }
        $carpeta1 = "../server/" . $id . "/comprobantes/factura";
        if (!file_exists($carpeta1)) {
            mkdir($carpeta1, 0777, true);
        }
        $carpeta2 = "../server/" . $id . "/comprobantes/factura/errores";
        if (!file_exists($carpeta2)) {
            mkdir($carpeta2, 0777, true);
        }
        $carpeta3 = "../server/" . $id . "/comprobantes/factura/codigosbarras";
        if (!file_exists($carpeta3)) {
            mkdir($carpeta3, 0777, true);
        }
    //guia
        $carpeta1 = "../server/" . $id . "/comprobantes/guia";
        if (!file_exists($carpeta1)) {
            mkdir($carpeta1, 0777, true);
        }
        $carpeta2 = "../server/" . $id . "/comprobantes/guia/errores";
        if (!file_exists($carpeta2)) {
            mkdir($carpeta2, 0777, true);
        }
        $carpeta3 = "../server/" . $id . "/comprobantes/guia/codigosbarras";
        if (!file_exists($carpeta3)) {
            mkdir($carpeta3, 0777, true);
        }
    //retencion
        $carpeta1 = "../server/" . $id . "/comprobantes/retencion";
        if (!file_exists($carpeta1)) {
            mkdir($carpeta1, 0777, true);
        }
        $carpeta2 = "../server/" . $id . "/comprobantes/retencion/errores";
        if (!file_exists($carpeta2)) {
            mkdir($carpeta2, 0777, true);
        }
        $carpeta3 = "../server/" . $id . "/comprobantes/retencion/codigosbarras";
        if (!file_exists($carpeta3)) {
            mkdir($carpeta3, 0777, true);
        }
    //notacredito
        $carpeta1 = "../server/" . $id . "/comprobantes/notacredito";
        if (!file_exists($carpeta1)) {
            mkdir($carpeta1, 0777, true);
        }
        $carpeta2 = "../server/" . $id . "/comprobantes/notacredito/errores";
        if (!file_exists($carpeta2)) {
            mkdir($carpeta2, 0777, true);
        }
        $carpeta3 = "../server/" . $id . "/comprobantes/notacredito/codigosbarras";
        if (!file_exists($carpeta3)) {
            mkdir($carpeta3, 0777, true);
        }
    //notadebito
        $carpeta1 = "../server/" . $id . "/comprobantes/notadebito";
        if (!file_exists($carpeta1)) {
            mkdir($carpeta1, 0777, true);
        }
        $carpeta2 = "../server/" . $id . "/comprobantes/notadebito/errores";
        if (!file_exists($carpeta2)) {
            mkdir($carpeta2, 0777, true);
        }
        $carpeta3 = "../server/" . $id . "/comprobantes/notadebito/codigosbarras";
        if (!file_exists($carpeta3)) {
            mkdir($carpeta3, 0777, true);
        }
    //liquidacion
        $carpeta1 = "../server/" . $id . "/comprobantes/liquidacion";
        if (!file_exists($carpeta1)) {
            mkdir($carpeta1, 0777, true);
        }
        $carpeta2 = "../server/" . $id . "/comprobantes/liquidacion/errores";
        if (!file_exists($carpeta2)) {
            mkdir($carpeta2, 0777, true);
        }
        $carpeta3 = "../server/" . $id . "/comprobantes/liquidacion/codigosbarras";
        if (!file_exists($carpeta3)) {
            mkdir($carpeta3, 0777, true);
        }
    //facturacompra
        $carpeta4 = "../server/" . $id . "/comprobantes/facturacompra";
        if (!file_exists($carpeta4)) {
            mkdir($carpeta4, 0777, true);
        }
        $carpeta5 ="../server/".$id."/comprobantes/facturacompra/errores";
        if (!file_exists($carpeta5)) {
            mkdir($carpeta5, 0777, true);
        }
        $carpeta6 ="../server/".$id."/comprobantes/facturacompra/codigosbarras";
        if (!file_exists($carpeta5)) {
            mkdir($carpeta5, 0777, true);
        }
    //guiacompra
        $carpeta4 = "../server/" . $id . "/comprobantes/guiacompra";
        if (!file_exists($carpeta4)) {
            mkdir($carpeta4, 0777, true);
        }
        $carpeta5 ="../server/".$id."/comprobantes/guiacompra/errores";
        if (!file_exists($carpeta5)) {
            mkdir($carpeta5, 0777, true);
        }
        $carpeta6 ="../server/".$id."/comprobantes/guiacompra/codigosbarras";
        if (!file_exists($carpeta5)) {
            mkdir($carpeta5, 0777, true);
        }
    //notacredito
        $carpeta4 = "../server/" . $id . "/comprobantes/notacreditocompra";
        if (!file_exists($carpeta4)) {
            mkdir($carpeta4, 0777, true);
        }
        $carpeta5 ="../server/".$id."/comprobantes/notacreditocompra/errores";
        if (!file_exists($carpeta5)) {
            mkdir($carpeta5, 0777, true);
        }
        $carpeta6 ="../server/".$id."/comprobantes/notacreditocompra/codigosbarras";
        if (!file_exists($carpeta5)) {
            mkdir($carpeta5, 0777, true);
        }
    //notadebito
        $carpeta4 = "../server/" . $id . "/comprobantes/notadebito";
        if (!file_exists($carpeta4)) {
            mkdir($carpeta4, 0777, true);
        }
        $carpeta5 ="../server/".$id."/comprobantes/notadebito/errores";
        if (!file_exists($carpeta5)) {
            mkdir($carpeta5, 0777, true);
        }
        $carpeta6 ="../server/".$id."/comprobantes/notadebito/codigosbarras";
        if (!file_exists($carpeta5)) {
            mkdir($carpeta5, 0777, true);
        }
    //retencioncompras
        $carpeta4 = "../server/" . $id . "/comprobantes/retencioncompra";
        if (!file_exists($carpeta4)) {
            mkdir($carpeta4, 0777, true);
        }
        $carpeta5 ="../server/".$id."/comprobantes/retencioncompra/errores";
        if (!file_exists($carpeta5)) {
            mkdir($carpeta5, 0777, true);
        }
        $carpeta6 ="../server/".$id."/comprobantes/retencioncompra/codigosbarras";
        if (!file_exists($carpeta5)) {
            mkdir($carpeta5, 0777, true);
        }
    //liquidacioncompra
        $carpeta4 = "../server/" . $id . "/comprobantes/liquidacioncompra";
        if (!file_exists($carpeta4)) {
            mkdir($carpeta4, 0777, true);
        }
        $carpeta5 ="../server/".$id."/comprobantes/liquidacioncompra/errores";
        if (!file_exists($carpeta5)) {
            mkdir($carpeta5, 0777, true);
        }
        $carpeta6 ="../server/".$id."/comprobantes/liquidacioncompra/codigosbarras";
        if (!file_exists($carpeta5)) {
            mkdir($carpeta5, 0777, true);
        }
