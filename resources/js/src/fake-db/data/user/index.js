...
mock.onPost("/api/auth/login1").reply((request) => {
...
mock.onPost('/api/auth/register1').reply((request) => {
...
mock.onPost('/api/auth/refresh-token1').reply((request) => {
...
mock.onGet("/api/user/checkpoint-reward1").reply(() => {
