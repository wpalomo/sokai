    ...
    <vs-table stripe :data="contenido">
      ...
      <template slot-scope="{data}">
        <vs-tr :key="datos.id_formula_produccion" v-for="datos in data">
          ...
          <vs-td v-else>-</vs-td>
          <vs-td v-if="datos.nombre_form" style="width:50%!important;">{{datos.nombre_form}}</vs-td>
          <vs-td v-else>-</vs-td>
          <!-- <vs-td v-if="datos.nomprod" style="width:60%!important;">{{datos.nomprod}}</vs-td>
          <vs-td v-else>-</vs-td>-->
          <vs-td class="whitespace-no-wrap" style="width:20%!important;">
            <feather-icon
              v-if="editarrol"
              icon="EditIcon"
