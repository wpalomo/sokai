...
<template>
    <div class="h-screen flex w-full bg-img">
        <div class="vx-col flex items-center justify-center flex-col sm:w-1/2 md:w-3/5 lg:w-3/4 xl:w-1/2 mx-auto text-center">
            ...
            <h1 class="sm:mx-0 mx-4 mb-12 text-5xl d-theme-heading-color">{{ $t("titulo404") }}</h1>
            <p class="sm:mx-0 mx-4 mb-4 sm:mb-16 d-theme-text-inverse" style="color:#2c2c2c"> {{ $t("descripcion404") }} </p>
            <vs-button size="large" to="/"> {{ $t("boton404") }} </vs-button>
        </div>
    </div>
</template>
