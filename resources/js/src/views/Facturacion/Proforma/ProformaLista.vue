    ...
    <vx-card>
      <div class="flex flex-wrap justify-between items-center mb-3">
        ...
        <div class="flex flex-wrap items-center justify-between ag-grid-table-actions-right">
          ...
          <div class="dropdown-button-container" v-if="crearrol">
            <vs-button class="btnx" type="filled" to="/facturacion/proforma/agregar">Agregar</vs-button>
            <vs-dropdown>
      ...
      <vs-table stripe :data="contenido">
        ...
        <template slot-scope="{data}">
          <vs-tr :key="datos.id_factura" v-for="datos in data">
  ...
  computed: {
    ...
    crearrol() {
      ...
      if(this.usuario.id_rol==1){
        ...
        res = this.$store.state.Roles[12].crear;
      }
      return res;
    },
    editarrol(){
      ...
      if(this.usuario.id_rol==1){
        ...
        res = this.$store.state.Roles[12].editar;
      }
      return res;
    },
    eliminarrol(){
      ...
      if(this.usuario.id_rol==1){
        ...
        res = this.$store.state.Roles[12].eliminar;
      }
      return res;
    }
  },
