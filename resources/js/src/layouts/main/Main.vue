...
export default {
  ...
  data() {
    return {
      ...
      navMenuItems      : navMenuItems,
      navMenuLogo       : '/images/logo/sello1.png', 
      routerTransition  : themeConfig.routerTransition || 'none',
      routeTitle        : this.$route.meta.pageTitle,
      steps: [{
          target  : '#btnVNavMenuMinToggler',
          content : this.$t('infomenuleft')
        },
        {
          target  : '.bookmark-container',
          content : this.$t('estrella')
        },
        {
          target  : '.i18n-locale',
          content : this.$t('idioma')
        },
        {
          target  : '.navbar-fuzzy-search',
          content : this.$t('busquedageneral')
        },
        {
          target  : '.the-navbar__user-meta',
          content : this.$t('miperfil'), 
          params  : {
            placement: 'left'
          }
        },
        {
          ...
          content : this.$t('configplantilla'), 
          params  : {
            placement: 'left'
          }
        },
