      ...
      <div class="h-full">
        ...
        <VuePerfectScrollbar class="scroll-area--customizer pt-4 pb-6" :settings="settings">
          <div class="px-6">
            ...
            <!-- THEME -->
            <div class="mt-4">
              <h5 class="mb-2">{{ $t('t_color') }}</h5>
              <div>
                <vs-radio v-model="themeMode" vs-value="light" class="mr-4" vs-name="theme-mode-light">{{ $t('t_claro') }}</vs-radio>
                <vs-radio v-model="themeMode" vs-value="dark" class="mr-4" vs-name="theme-mode-dark">{{ $t('t_oscuro') }}</vs-radio>
                <vs-radio
                  v-if="layoutType === 'vertical'"
                  v-model="themeMode"
                  vs-value="semi-dark"
                  vs-name="theme-mode-semi-dark">{{ $t('t_semioscuro') }}</vs-radio>
              </div>
            </div>
            ...
            <div class="mt-4">
              ...
              <div>
                <vs-radio
                  ...
                  vs-value="hidden"
                  class="mr-4"
                  vs-name="navbar-type-hidden">{{ $t('oculto') }}</vs-radio>

                <!--<vs-radio v-model="navbarTypeLocal" vs-value="static" class="mr-4" vs-name="navbar-type-static">{{ $t('estatico') }}</vs-radio>-->
                <vs-radio v-model="navbarTypeLocal" vs-value="sticky" vs-name="navbar-type-sticky" class="mr-4">{{ $t('pegado') }}</vs-radio>
                <vs-radio v-model="navbarTypeLocal" vs-value="floating" vs-name="navbar-type-floating">{{ $t('flotante') }}</vs-radio>
              </div>
            </div>
            ...
            <!-- FOOTER TYPE -->
            <div class="mt-4">
              <h5 class="mb-2">{{ $t('t_menuf') }}</h5>
              <div>
                <vs-radio v-model="footerTypeLocal" vs-value="hidden" class="mr-4" vs-name="footer-type-hidden">{{ $t('oculto') }}</vs-radio>
                <vs-radio v-model="footerTypeLocal" vs-value="static" class="mr-4" vs-name="footer-type-static">{{ $t('estatico') }}</vs-radio>
                <vs-radio v-model="footerTypeLocal" vs-value="sticky" vs-name="footer-type-sticky">{{ $t('pegado') }}</vs-radio>
              </div>
            </div>
            ...
            <!-- ROUTER ANIMATION -->
            <div class="mt-4">
              <h5 class="mb-2">{{ $t('t_animacion') }}</h5>
