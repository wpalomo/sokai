  ...
  <div class="parentx">
    ...
    <vs-sidebar
      ...
      <div @mouseenter="mouseEnter" @mouseleave="mouseLeave">
        ...
        <!-- Header -->
        <div class="header-sidebar flex items-end justify-between mb-3" slot="header" style="position: relative;height: 65px;">
          <!-- Logo -->
          <router-link tag="div" class="vx-logo cursor-pointer flex items-center" to="/">
            <img v-if="tema=='light'" src="/images/logo/logo-1.png" alt="logo" style="position: absolute;top: 3px;width: 14rem;left: 8px;margin-top: 7px;margin-left: 7px;">
            <img v-else src="/images/logo/logo-8.png" alt="logo" style="position: absolute;top: 3px;width: 14rem;left: 8px;margin-top: 7px;margin-left: 7px;">
            <!--<span class="vx-logo-text" style="">Vuexy</span>-->
          </router-link>
          <!-- /Logo -->
