    ...
    <vs-navbar class="vx-navbar navbar-custom navbar-skelton" :color="navbarColorLocal">
      ...
      <vs-dropdown vs-custom-content vs-trigger-click class="cursor-pointer">
        ...
        <vs-dropdown-menu class="w-48 i18n-dropdown vx-navbar-dropdown">
          <vs-dropdown-item @click="updateLocale('es')"><img class="h-4 w-5 mr-2" src="@assets/images/flags/es.png" alt="es" /> &nbsp;Español</vs-dropdown-item>
      ...
      <!--<vs-dropdown vs-custom-content vs-trigger-click class="cursor-pointer">
          ...
          <vs-dropdown-menu class="cart-dropdown vx-navbar-dropdown" :class="{'dropdown-custom': cartItems.length}">
              ...
              <!-- IF CART IS EMPTY -->
              <!--<template v-else>
                  <p class="p-4">Tu carrito esta vacío.</p>
              </template>
          </vs-dropdown-menu>
      </vs-dropdown>-->
      ...
      <div class="the-navbar__user-meta flex items-center">
        <div class="text-right leading-tight hidden sm:block">
          <p class="font-semibold">{{ usuario.nombres + ' ' + usuario.apellidos }}</p>
          ...
          <vs-dropdown-menu class="vx-navbar-dropdown">
            <ul style="min-width: 9rem">
              <li
                ...
                @click="$router.push('/menu/perfil').catch(() => {})">
              ...
              <li
                class="flex py-2 px-4 cursor-pointer hover:bg-primary hover:text-white"
                @click="$router.push('/menu/configuracion').catch(() => {})">

                <feather-icon icon="MailIcon" svgClasses="w-4 h-4" />
                <span class="ml-2">{{$t("Configuracion")}}</span>
              </li>
